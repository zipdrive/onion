...
namespace onion
{
	namespace world
	{
		...
		// A sprite sheet that uses a normal map to determine the shading of each fragment.
		class NormalMapped3DPixelSpriteSheet : public PixelSpriteSheet<FLOAT_MAT4X2, FLOAT_MAT4, Int>
		{
		protected:
			// The shader program for the sprite sheet.
			static _SpriteShader* m_NormalMapped3DPixelShader;

			// Stores texture information of the sprite sheet.
		...
		public:
			...
			/// <summary>Loads a sprite sheet from file.</summary>
			/// <param name="path">The path to the image file, from the res/img/world/ folder.</param>
			NormalMapped3DPixelSpriteSheet(const char* path);

			/// <summary>
			/// Retrieves the texture with the given ID.
			/// </summary>
			/// <param name="id">The ID of the texture to retrieve.</param>
			/// <returns>The texture with the given ID. NULL if there is none.</returns>
		...
		class DynamicShadingSpriteGraphic3D : public SpriteGraphic3D<NormalMapped3DPixelSpriteSheet>
		{
		protected:
		...
		public:
			...
			DynamicShadingSpriteGraphic3D(const NormalMapped3DPixelSpriteSheet* sprite_sheet, const std::vector<const Sprite*>& sprites, bool flip_horizontally, const Texture* texture, Palette* palette);
		...
		typedef _BillboardedGraphic3D<FlatWallGraphic3D> 
			BillboardedFlatWallGraphic3D;

		typedef _BillboardedGraphic3D<DynamicShadingSpriteGraphic3D> 
			BillboardedDynamicShadingSpriteGraphic3D;
